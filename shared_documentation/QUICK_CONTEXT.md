...
**Contains**: Architecture, specs, dependencies, logic, status (Implemented/Planned/Future)  
**Note**: This is NOT for development tracking - it's the spec of the finished system
...
- **Architecture Spec**: `shared_documentation/architecture/MASTER_ARCHITECTURE.md`
